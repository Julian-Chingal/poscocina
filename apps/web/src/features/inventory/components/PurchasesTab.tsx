                  ...
                  <TableRow key={purchase.id}>
                    ...
                    <TableCell>
                      {purchase.status === 'received' ? (
                        <Badge variant="outline" className="inline-flex items-center space-x-1 text-[11px] font-bold text-emerald-400 bg-emerald-950/60 border-emerald-800/40 px-2.5 py-0.5">
                          <CheckCircle className="w-3 h-3 mr-1" />
                          <span>Recibida (Stock Actualizado)</span>
                        </Badge>
                      ) : purchase.status === 'draft' ? (
                        <Badge variant="outline" className="inline-flex items-center space-x-1 text-[11px] font-bold text-amber-400 bg-amber-950/60 border-amber-800/40 px-2.5 py-0.5">
                          <Clock className="w-3 h-3 mr-1" />
                          <span>Borrador (Pendiente)</span>
                        </Badge>
                      ) : (
                        <Badge variant="outline" className="inline-flex items-center space-x-1 text-[11px] font-bold text-rose-400 bg-rose-950/60 border-rose-800/40 px-2.5 py-0.5">
                          <span>Cancelada</span>
                        </Badge>
                      )}
                    </TableCell>
