...
export const StockTable: React.FC<Props> = ({
  ...
  <Card className="w-full min-w-0 shadow-sm overflow-hidden">
    <CardHeader className="p-4 sm:p-6 pb-4 border-b border-border">
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        ...
        <Button
          ...
          className="flex items-center space-x-2 bg-primary hover:bg-primary/90 text-primary-foreground px-4 py-2 h-auto rounded-xl text-xs font-bold transition cursor-pointer shadow-lg shadow-primary/20 shrink-0"
        >
        ...
        <Table className="table-fixed w-full min-w-[650px]">
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="w-[14%]">Stock Actual</TableHead>
              <TableHead className="w-[16%]">Costo / Unidad</TableHead>
            ...
            {items.map((item) => {
              ...
              return (
                <TableRow key={item.id}>
                  <TableCell className="font-bold text-foreground truncate">{item.name}</TableCell>
                  ...
                  <TableCell className="text-right">
                    ...
                    >
                      <ArrowDownRight className="w-3 h-3 text-emerald-600 dark:text-emerald-400 shrink-0" />
                      <span>Ajustar</span>
                    </Button>
                  </TableCell>
                </TableRow>
