...
export const AppLauncherView: React.FC<AppLauncherViewProps> = ({
  ...
  return (
    <div className="min-h-[calc(100vh-48px)] flex flex-col items-center justify-center p-6 sm:p-12 relative overflow-hidden bg-background text-foreground transition-colors">
